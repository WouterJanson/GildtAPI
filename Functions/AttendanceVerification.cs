...
namespace GildtAPI.Functions
{
    public static class AttendanceVerification
    {
            ...
            int? eventId)
        {
            ...
            var attendanceList = await AttendanceDAO.Instance.GetAttendanceListAsync(eventId, count);
            ...
            int userId)
        {
            ...
            var attendanceList = await AttendanceDAO.Instance.GetUserAttendanceListAsync(userId, count);
            if (attendanceList.Count == 0) {
